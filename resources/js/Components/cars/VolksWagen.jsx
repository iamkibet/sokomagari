...
export const VolksWagen = () => {
    return (
        ...
        >
            <g>
                <path
                    d="M263.3,3.7C120.2,3.7,3.5,120.4,3.5,263.5c0,143.1,116.7,259.8,259.8,259.8c143.1,0,259.8-116.7,259.8-259.8
		...
		s229.8,103.2,229.8,229.8C493.1,390.1,389.8,493.3,263.3,493.3L263.3,493.3z"
                ...
                <path
                    d="M359.4,98.9c23.3,13.7,43.4,32.1,59.1,54l-95,201.9l-32-77.1h-56.4l-32,77.1l-95-201.9c15.7-21.9,35.8-40.4,59.1-54
